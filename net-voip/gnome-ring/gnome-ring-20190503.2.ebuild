...
#	cmake-utils_src_configure
	...
	echo "FIX SANDBOX VIOLATION"
	sed -i 's/EXECUTE_PROCESS/#NOOP/' cmake_install.cmake
#	sed -i 's/.*EXECUTE_PROCESS\(COMMAND rm \/usr\/bin\/ring.cx -f\)/#NOOP/' cmake_install.cmake
#	sed -i 's/.*EXECUTE_PROCESS\(COMMAND ln -s \/usr\/bin\/jami \/usr\/bin\/ring.cx\).*/#NOOP/' cmake_install.cmake
}
